...
/*   Updated: 2024/04/07 22:03:47 by aperis-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init(t_game *cub)
{
	...
	// cub->p1 = coordinate(22, 12); //this need to be set accordingly with the position of the player on the matrix dinamically
